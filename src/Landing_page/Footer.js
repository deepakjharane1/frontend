...
function Footer() {
  return (
    ...
    <div className="container mt-5" >
      <div className="row mt-5">
        <div className="col">
          <img
            ...
            alt="logo"
          />
          <p className="mt-4 fs-8 text-secondary">&copy; 2010 - 2024, Zerodha Broking Ltd.  All rights reserved</p>
        ...
        <div className="col">
          ...
          <br></br>
          <a href="" style={{color: 'grey'}}>Product</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Pricing</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Referral programme</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Careers</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Zerodha.tech</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Press & media</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Zerodha cares (CSR)</a>
          
        </div>
        <div className="col">
          <h5>Support</h5>
          <a href="" style={{color: 'grey'}}>Contact us</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Support portal</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Z-Connect blog</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>List of charge</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Downloads & resources</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Videos</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Markets overview</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>How to file & complaint</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Status of your & complaints</a>
          
        </div>
        <div className="col">
          <h5>Accounts</h5>
          <a href="" style={{color: 'grey'}}>Open an account</a>
          <br></br>
          <a href="" style={{color: 'grey'}}>Fund transfer</a>
        </div>
      </div>
      ...
      <a href=""  style={{fontSize:'0.7rem'}}>Smart Online Dispute Resolution | Grievances Redressal Mechanism</a>
    ...
    <div  className="container d-flex justify-content-evenly mb-4">
        <a href="" style={{color: 'grey'}}>NSE</a>
        <a href="" style={{color: 'grey'}}>BSE</a>
        <a href="" style={{color: 'grey'}}>Termx & condition</a>
        <a href="" style={{color: 'grey'}}>Policies & procedures</a>
        <a href="" style={{color: 'grey'}}>Privacy policy</a>
        <a href="" style={{color: 'grey'}}>Disclosure</a>
        <a href="" style={{color: 'grey'}}>For inverster's attention</a>
        <a href="" style={{color: 'grey'}}>Inverste charter</a>
    </div>
    </footer>
  );
}
