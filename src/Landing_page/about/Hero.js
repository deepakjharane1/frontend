    ...
    return ( 
       <div className='container '>
        <div className='row mt-5 mb-5'>
            <h1 className='fs-3 text-center mt-5 mb-5'>We pioneered the discount broking model in India.<br></br>
            Now, we are breaking ground with our technology.</h1>
        </div>

        <div className='row mt-5  border-top text-muted ' style={{fontSize:'1.1rem', fontWeight:'400'}}>
